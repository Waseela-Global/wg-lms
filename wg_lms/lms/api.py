...
from wg_lms.lms.doctype.course_lesson.course_lesson import save_progress
from wg_lms.lms.utils import get_average_rating, get_lesson_count
...
def get_unsplash_photos(keyword=None):
	from wg_lms.unsplash import get_by_keyword, get_list
