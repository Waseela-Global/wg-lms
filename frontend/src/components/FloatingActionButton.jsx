  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
        ...
        <div className="absolute bottom-16 right-0 mb-2 space-y-2">
          {canCreateCourse && (
            <Link
              ...
              className="flex items-center justify-end gap-3 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 px-4 py-3 hover:shadow-xl transition-all group"
      ...
      <button
        ...
        className="w-14 h-14 rounded-full bg-primary-600 hover:bg-primary-700 text-white shadow-lg hover:shadow-xl transform hover:scale-110 transition-all duration-200 flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
